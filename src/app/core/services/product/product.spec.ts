...
describe('ProductService', () => {
  ...
  it(
    'should request products using GET',
    () => {
      const request =
        httpTesting.expectOne({
          method: 'GET',
  ...
  it(
    'should expose initial loading state',
    () => {
      expect(
        service.products()
      ).toEqual([]);
      ...
      expect(
        service.isInitialLoading()
      ).toBe(true);

      expect(
        service.hasBlockingError()
      ).toBe(false);
  ...
  it(
    'should return undefined when product does not exist',
    async () => {
      const request =
        httpTesting.expectOne(
          '/data/products.json'
  ...
  it(
    'should expose a blocking error when initial request fails',
    async () => {
      const request =
        httpTesting.expectOne(
          '/data/products.json'
  ...
  it(
    'should reload products and preserve the old value while loading',
    async () => {
