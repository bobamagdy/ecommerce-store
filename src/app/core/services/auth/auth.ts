...
export class AuthService {
  ...
  private readonly authenticationMarker =
    'authenticated';
  ...
  private readAuthenticationState():
    boolean {
    return (
      this.hasValidAuthentication(
        this.localStorage
      ) ||
      this.hasValidAuthentication(
        this.sessionStorage
  ...
  private clearStoredAuthentication():
    void {
